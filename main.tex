...
\definecolor{wit-red}{HTML}{9A1E13}
...
% Umieszczanie notatek typu "todo"
\usepackage{todonotes} 

% Obsługa przypadków w równaniach matematycznych
\usepackage{cases}

% Pozwala na użycie komendy `\include` bez automatycznego wstawiania nowej strony
\usepackage{newclude}

% Pozwala na automatyczne zliczanie sekcji
\usepackage{totcount}
...
% Pozbycie się pustych stron po rozdziałach przy pomocy redfinicji.
...
\fancypagestyle{custom}{
	...
	\fancyhead[LE]{								% Lewy, parzysty nagłówek
		...
		\put(-17.5, 10){%
			\makebox(0,0)[l]{%
				\includegraphics[width=0.03\textwidth]{images/wit-logo.png}
			}
		}
		\put(-287.5, 8.5){%
			\makebox(0,0)[l]{%
...
% Formatowanie tytułów podsekcji
\titleformat{\subsection}					% kształt
{
	\Large\bfseries
}												% formatowanie tekstu modyfikowanego elementu
{
	\thesubsection									% etykieta występująca przed tekstem modyfikowanego elementu, niewidoczna w spisie treści
}
{
	0pt
}												% odstęp formatowanego tytułu od lewego marginesu/etykiety
...
% Formatowanie tytułów podpodsekcji
\titleformat{\subsubsection}[hang]					% kształt
{
	\large\bfseries
}												% formatowanie tekstu modyfikowanego elementu
{
	\thesubsubsection									% etykieta występująca przed tekstem modyfikowanego elementu, niewidoczna w spisie treści
}
{
	0pt
}												% odstęp formatowanego tytułu od lewego marginesu/etykiety
...
% Formatowanie tytułów podpodsekcji
\titleformat{\paragraph}[hang]					% kształt
{
	\normalfont\bfseries
}												% formatowanie tekstu modyfikowanego elementu
{
	\theparagraph									% etykieta występująca przed tekstem modyfikowanego elementu, niewidoczna w spisie treści
}
{
	0pt
}												% odstęp formatowanego tytułu od lewego marginesu/etykiety
...
\hypersetup{
	...
	linkcolor	=	wit-red,					% Kolory: referencji,
    citecolor	=	wit-red,					% cytowań,
	urlcolor	=	wit-red					% hiperlinków.
}
...
% Umożliwia automatyczne przeliczanie i wyświetlanie liczb w systemie rzymskim
\usepackage{romannum}

% Obsługa obrazów w formacie .svg
\usepackage{svg}
...
% Set up the thesis
\author{Michał Karbownik}
\title{Representation Learning with Bayesian Methods}
\supervisor{dr hab. inż.Tomasz Kajdanowicz}
\fieldofstudy{Artificial Intelligence}
\specialty{}
\keywords{%TODO
Bayesian representation learning, Bayesian, representation, deep learning, uncertainty}
\summary{%TODO 
...
% 	\cleardoublepage
	...
	\input{observational/observational}
% 	\cleardoublepage
	
	\input{quantitative/quantitative}
% 	\cleardoublepage
